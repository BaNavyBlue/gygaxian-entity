...
void OptionWindow::PlaceOptions() {
    ...
    drawSmall(_optScreen->xyLimits.minX, _optScreen->xyLimits.maxX, _optScreen->xyLimits.minY,
...
PrintInfo::PrintInfo(Entity chrctr, DrawRange uRandWidth, Perimeter inPerim, ScreenVals &primary, int horz, int vert) {
    ...
    for (int i = 0; i < _infoScreen.size(); ++i) {
        drawSmall(_infoScreen[i]->xyLimits.minX, _infoScreen[i]->xyLimits.maxX, _infoScreen[i]->xyLimits.minY,
...
void PrintInfo::MakeGenTbl(std::vector<std::string> stringVect) {
    ...
    drawSmall(_infoScreen[scrnIdx]->xyLimits.minX, _infoScreen[scrnIdx]->xyLimits.maxX,
              _infoScreen[scrnIdx]->xyLimits.minY, _infoScreen[scrnIdx]->xyLimits.maxY + 1, *_infoScreen[scrnIdx]);
    ...
    drawSmall(_infoScreen[scrnIdx]->xyLimits.minX, _infoScreen[scrnIdx]->xyLimits.maxX,
              _infoScreen[scrnIdx]->xyLimits.minY, _infoScreen[scrnIdx]->xyLimits.maxY + 1, *_primaryScreen);
    ...
    for (int i = 0; i < _infoScreen.size(); ++i) {
        drawSmall(_infoScreen[i]->xyLimits.minX, _infoScreen[i]->xyLimits.maxX, _infoScreen[i]->xyLimits.minY,
                  _infoScreen[i]->xyLimits.maxY + 1, *_infoScreen[i]);
    }
}
...
void PrintInfo::MakeCharWin() {
    ...
    drawSmall(_infoScreen[0]->xyLimits.minX, _infoScreen[0]->xyLimits.maxX, _infoScreen[0]->xyLimits.minY,
              _infoScreen[0]->xyLimits.maxY + 1, *_infoScreen[0]);
}
...
void PrintInfo::MakeStatsWin() {
    ...
    if (_character->getStats().strength > 17 &&
        (_character->getClass()[0] == FIGHTER || _character->getClass()[0] == PALADIN ||
    ...
    drawSmall(_infoScreen[1]->xyLimits.minX, _infoScreen[1]->xyLimits.maxX, _infoScreen[1]->xyLimits.minY,
              _infoScreen[1]->xyLimits.maxY + 1, *_infoScreen[1]);
}
...
void PrintInfo::MakeCmbtWin() {
    ...
    char varIn[32];
    basicInfo.back() +=
        "(" + std::to_string(_character->getCurHP()) + "/" + std::to_string(_character->getMaxHP()) + ")";
    ...
    PlaceInfo(2);
    drawSmall(_infoScreen[2]->xyLimits.minX, _infoScreen[2]->xyLimits.maxX, _infoScreen[2]->xyLimits.minY,
              _infoScreen[2]->xyLimits.maxY + 1, *_infoScreen[2]);
}
...
void PrintInfo::MakeProfWin() {
    ...
    PlaceInfo(3);
    drawSmall(_infoScreen[3]->xyLimits.minX, _infoScreen[3]->xyLimits.maxX, _infoScreen[3]->xyLimits.minY,
              _infoScreen[3]->xyLimits.maxY + 1, *_infoScreen[3]);
}
...
void PrintInfo::MakeEscTag() {
    ...
    _infoScreen[6]->xyLimits.minY = healCom.minY = _infoScreen[0]->xyLimits.maxY + 1;
    _infoScreen[6]->xyLimits.maxX = healCom.maxX = _infoScreen[0]->xyLimits.minX + maxLen + 7;
    _infoScreen[6]->xyLimits.maxY = healCom.maxY = _infoScreen[6]->xyLimits.minY + basicInfo.size() + 1;
    generatePerimeter(*_infoScreen[6], _infoBoxPerim);
    _contents.push_back(basicInfo);

    PlaceInfo(6);
    drawSmall(_infoScreen[6]->xyLimits.minX, _infoScreen[6]->xyLimits.maxX, _infoScreen[6]->xyLimits.minY,
              _infoScreen[6]->xyLimits.maxY + 1, *_infoScreen[6]);
}
...
void PrintInfo::MakeWealthWin() {
    ...
    PlaceInfo(4);
    drawSmall(_infoScreen[4]->xyLimits.minX, _infoScreen[4]->xyLimits.maxX, _infoScreen[4]->xyLimits.minY,
              _infoScreen[4]->xyLimits.maxY + 1, *_infoScreen[4]);
}
...
void PrintInfo::MakeLangWin() {
    ...
    PlaceInfo(5);
    drawSmall(_infoScreen[5]->xyLimits.minX, _infoScreen[5]->xyLimits.maxX, _infoScreen[5]->xyLimits.minY,
              _infoScreen[5]->xyLimits.maxY + 1, *_infoScreen[5]);
}
...
void PrintInfo::MakeDexTbl() {
    ...
    PlaceInfo(screenIdx);
    drawSmall(_infoScreen[screenIdx]->xyLimits.minX, _infoScreen[screenIdx]->xyLimits.maxX,
              _infoScreen[screenIdx]->xyLimits.minY, _infoScreen[screenIdx]->xyLimits.maxY + 1,
    ...
    drawSmall(_infoScreen[screenIdx]->xyLimits.minX, _infoScreen[screenIdx]->xyLimits.maxX,
              _infoScreen[screenIdx]->xyLimits.minY, _infoScreen[screenIdx]->xyLimits.maxY + 1, *_primaryScreen);
...
void PrintInfo::MakeRaceSkills() {
    ...
    PlaceInfo(10);
    drawSmall(_infoScreen[10]->xyLimits.minX, _infoScreen[10]->xyLimits.maxX, _infoScreen[10]->xyLimits.minY,
...
std::string getUTF(int inCode) {
    ...
    case 2:
        ...
        return utf8Result;
    case 3:
        sprintf(utf8Result, "%c%c%c", (char)(0xE0 | (inCode >> 12)), (char)(0x80 | ((inCode >> 6) & 0x3F)),
                (char)(0x80 | (inCode & 0x3F)));
        utf8Result[4] = '\0';
        return utf8Result;
    case 4:
        sprintf(utf8Result, "%c%c%c%c", (char)(0xF0 | (inCode >> 18)), (char)(0x80 | ((inCode >> 12) & 0x3F)),
                (char)(0x80 | ((inCode >> 6) & 0x3F)), (char)(0x80 | (inCode & 0x3F)));
        utf8Result[4] = '\0';
        return utf8Result;
    }
    return "\0";
...
void ListHighlight::createListScreen(ScreenVals &inScreen, std::vector<std::string> inList, std::string inTitle,
    ...
    int titlePos =
        inScreen.xyLimits.maxX - (inScreen.xyLimits.maxX - inScreen.xyLimits.minX) / 2 - inTitle.size() / 2 - 1;
    if (titlePos < 0)
        titlePos = 0;
    // Print Title
        ...
        if (kbhit()) {
            ...
            if (std::tolower(k) == 'a') {
                ...
                if (_destList.size() > 0) {
                    ...
                    if (std::tolower(k) == 's') {
                        if (_destList.size() > 0) {
                            drawSmall(_cornerDims.minX, _cornerDims.maxX, _cornerDims.minY, _cornerDims.maxY + 1,
                                      *_primaryScreen);
                            drawSmall(_destListScreen->xyLimits.minX, _destListScreen->xyLimits.maxX,
                                      _destListScreen->xyLimits.minY, _destListScreen->xyLimits.maxY + 1,
                                      *_primaryScreen);
                            TextInput partyName;
                            Perimeter textPerim(TL_LINE, TR_LINE, BL_LINE, BR_LINE, HORZ_LINE, VERT_LINE, MAGENTA,
                                                BLACK, BLUE, BLACK);
                            ...
                            drawSmall(partyName.getScreen().xyLimits.minX, partyName.getScreen().xyLimits.maxX,
                                      partyName.getScreen().xyLimits.minY, partyName.getScreen().xyLimits.maxY + 1,
                                      *_primaryScreen);
                            break;
                        }
                    } else if (k == KEY_ESCAPE) {
                        // drawSmall(_cornerDims.minX, _cornerDims.maxX,
                        // _cornerDims.minY, _cornerDims.maxY + 1,
                        // *_primaryScreen);
                        // drawSmall(_destListScreen->xyLimits.minX,
                        // _destListScreen->xyLimits.maxX,
                        //         _destListScreen->xyLimits.minY,
                ...
                if (_destList.size() > 0) {
                    drawSmall(_cornerDims.minX, _cornerDims.maxX, _cornerDims.minY, _cornerDims.maxY + 1,
                              *_primaryScreen);
                    drawSmall(_destListScreen->xyLimits.minX, _destListScreen->xyLimits.maxX,
                              _destListScreen->xyLimits.minY, _destListScreen->xyLimits.maxY + 1, *_primaryScreen);
                    TextInput partyName;
                    Perimeter textPerim(TL_LINE, TR_LINE, BL_LINE, BR_LINE, HORZ_LINE, VERT_LINE, MAGENTA, BLACK, BLUE,
                                        BLACK);
                    ...
                    do {
                        ...
                        if (doesRecordExist(partyName.getAquiredString(), "parties/", ".json")) {
                            WarnMessage nameExists("Party name already in use", "Overwrite? (y/n)");
                            confirmName = nameExists.waitForAnswer();
                            drawSmall(nameExists.getScreen().xyLimits.minX, nameExists.getScreen().xyLimits.maxX,
                                      nameExists.getScreen().xyLimits.minY, nameExists.getScreen().xyLimits.maxY + 1,
                                      *_primaryScreen);
                        }
        ...
        if (kbhit()) {
            ...
            if (std::tolower(k) == 'r') {
                ...
                if (_destList.size() > 0) {
                    ...
                    infoRange.minY = 1;
                    Perimeter rollPerim(0x256D, 0x256E, 0x2570, 0x256F, 0x2500, 0x2502, MAGENTA, BLACK, BLUE, BLACK);
                    PrintInfo showChar(_players.at(_destIdx[_destCurrPos]), infoRange, rollPerim, *_primaryScreen,
                                       tcols(), trows());
                    listNavigate();
                    destNavigate();
                    // createListPerimeter(*_destListScreen, _destOptions);
                ...
                //     inScreen.xyLimits.minY, inScreen.xyLimits.maxY,
                //     primaryScreen);
                return KEY_ESCAPE;
            }
...
void ListHighlightPair::listNavigate() {
    ...
    int titlePos = _listScreen->xyLimits.maxX - (_listScreen->xyLimits.maxX - _listScreen->xyLimits.minX) / 2 -
                   _title.size() / 2 - 1;
    if (titlePos < 0)
        titlePos = 0;
...
void ListHighlightPair::destNavigate() {
    ...
    int titlePos = _destListScreen->xyLimits.maxX -
                   (_destListScreen->xyLimits.maxX - _destListScreen->xyLimits.minX) / 2 - _destTitle.size() / 2 - 1;
    if (titlePos < 0)
        titlePos = 0;
...
ListHighlightPartySelect::ListHighlightPartySelect(std::vector<std::string> &inList,
    ...
    drawSmall(_cornerDims.minX, _cornerDims.maxX, _cornerDims.minY, _cornerDims.maxY + 1, *_listScreen);
    drawSmall(_partyListScreen->xyLimits.minX, _partyListScreen->xyLimits.maxX, _partyListScreen->xyLimits.minY,
        ...
        if (kbhit()) {
            ...
            if (std::tolower(k) == 'a') {
                ...
                if (_list.size() > 0) {
                    drawSmall(_cornerDims.minX, _cornerDims.maxX, _cornerDims.minY, _cornerDims.maxY + 1,
                              *_primaryScreen);
                    drawSmall(_listScreen->xyLimits.minX, _listScreen->xyLimits.maxX, _listScreen->xyLimits.minY,
                              _listScreen->xyLimits.maxY + 1, *_primaryScreen);
                    TextInput partyName;
                    Perimeter textPerim(TL_LINE, TR_LINE, BL_LINE, BR_LINE, HORZ_LINE, VERT_LINE, MAGENTA, BLACK, BLUE,
                                        BLACK);
                    _selIdx = _currPos;
...
void ListHighlightPartySelect::populatePartyList() {
    ...
    int titlePos = _partyListScreen->xyLimits.maxX -
                   (_partyListScreen->xyLimits.maxX - _partyListScreen->xyLimits.minX) / 2 - partyTitle.size() / 2 - 1;
    if (titlePos < 0)
        titlePos = 0;
...
ListHighlightProfSelect::ListHighlightProfSelect(Entity &inChar, ScreenVals &primaryScreen,
    ...
    _profAvailable = _player->getCharClassSkills()[0]->getInitNumWeap() +
                     (_player->getLevel() - 1) / _player->getCharClassSkills()[0]->getAddedWeapLevDen() - _profChosen;
    ...
    listNavigate();
    createListPerimeter(*_listScreen, _options);
    createProfListScreen(*_listScreen, _list, _title + std::to_string(_profAvailable), _highlightList, LIST);
    createPrimary(*_primaryScreen, _optMain);
    drawPrimary(*_primaryScreen);
    createListPerimeter(*_playerDestScreen, _playerOpts);
    createProfListScreen(*_playerDestScreen, _playerList, _player->getName(), false, DEST);

    // createDescription();
    drawSmall(_descriptionPanel->xyLimits.minX, _descriptionPanel->xyLimits.maxX, _descriptionPanel->xyLimits.minY,
              _descriptionPanel->xyLimits.maxY, *_descriptionPanel);
    drawSmall(_cornerDims.minX, _cornerDims.maxX, _cornerDims.minY, _cornerDims.maxY + 1, *_listScreen);
    drawSmall(_playerDestScreen->xyLimits.minX, _playerDestScreen->xyLimits.maxX, _playerDestScreen->xyLimits.minY,
              _playerDestScreen->xyLimits.maxY + 1, *_playerDestScreen);
    navigateSelection();
    drawSmall(_listScreen->xyLimits.minX, _listScreen->xyLimits.maxX, _listScreen->xyLimits.minY,
              _listScreen->xyLimits.maxY, *_primaryScreen);
    drawSmall(_playerDestScreen->xyLimits.minX, _playerDestScreen->xyLimits.maxX, _playerDestScreen->xyLimits.minY,
              _playerDestScreen->xyLimits.maxY, *_primaryScreen);
    drawSmall(_descriptionPanel->xyLimits.minX, _descriptionPanel->xyLimits.maxX, _descriptionPanel->xyLimits.minY,
              _descriptionPanel->xyLimits.maxY, *_primaryScreen);
}
...
void ListHighlightProfSelect::createDescription(profData profSel) {
    ...
    std::string description = _inventory->getInventoryList().at(ARMS).at(profSel.ARM_ID)->getDescription();
    ...
    while (true) {
        ...
        if (horz_char != new_horz || vert_char != new_vert) {
            ...
            drawSmall(_descriptionPanel->xyLimits.minX, _descriptionPanel->xyLimits.maxX,
                      _descriptionPanel->xyLimits.minY, _descriptionPanel->xyLimits.maxY, *_descriptionPanel);
            drawSmall(_playerDestScreen->xyLimits.minX, _playerDestScreen->xyLimits.maxX,
                      _playerDestScreen->xyLimits.minY, _playerDestScreen->xyLimits.maxY + 1, *_playerDestScreen);
            drawSmall(_cornerDims.minX, _cornerDims.maxX, _cornerDims.minY, _cornerDims.maxY + 1, *_listScreen);
        }
                    ...
                    if (std::tolower(k) == 's') {
                        if (_playerList.size() > 0) {
                            ...
                            drawSmall(_playerDestScreen->xyLimits.minX, _playerDestScreen->xyLimits.maxX,
                                      ...
                                      *_primaryScreen);
                            // Perimeter textPerim(TL_LINE, TR_LINE, BL_LINE,
                            // BR_LINE, HORZ_LINE, VERT_LINE, MAGENTA, BLACK,
                            // BLUE, BLACK);
                        }
        ...
        if (kbhit()) {
            ...
            if (std::tolower(k) == 'r') {
                ...
                if (_playerList.size() > 0 && _profAvailable < 1) {
                    ...
                    // createListPerimeter(*_destListScreen, _destOptions);
                    // createListScreen(*_destListScreen, _destList, _destTitle,
                    // _highlightDest); drawSmall(_cornerDims.minX,
                    // _cornerDims.maxX, _cornerDims.minY, _cornerDims.maxY + 1,
                    // *_listScreen);
                    // drawSmall(_playerDestiScreen->xyLimits.minX,
                    // _playerDestScreen->xyLimits.maxX,
                    //          _playerDestScreen->xyLimits.minY,
                    //          _playerDestScreen->xyLimits.maxY + 1,
                    //          *_playerDestScreen);
                }
            } else if (k == KEY_UP) {
                if (_destCurrPos > 0) {
...
void ListHighlightProfSelect::destNavigate() {
    ...
    int titlePos = _playerDestScreen->xyLimits.maxX -
                   (_playerDestScreen->xyLimits.maxX - _playerDestScreen->xyLimits.minX) / 2 -
    ...
    for (int i = 0; i < _player->getName().size(); ++i) {
        _playerDestScreen->charMap[_playerDestScreen->xyLimits.minY + 1][i + titlePos] = _player->getName()[i];
        _playerDestScreen->colorMap[_playerDestScreen->xyLimits.minY + 1][i + titlePos] = YELLOW;
    }

    for (int i = _playerDestScreen->xyLimits.minY + 3; i < _playerDestScreen->xyLimits.maxY - 1; ++i) {
        // int idxOffset = _currPos - _destListScreen->xyLimits.maxY + 6;
        ...
        if (strdx < _playerList.size()) {
            for (int j = 0; j < _playerList[strdx].size(); ++j) {
                if (strdx == _destCurrPos && _highlightDest) {
                    ...
                    _playerDestScreen->colorMap[i][j + _playerDestScreen->xyLimits.minX + 1] = textCol;
...
void clearPrevScreen(const std::vector<ScreenVals> &screens) {
    drawSmall(screens.back().xyLimits.minX, screens.back().xyLimits.maxX, screens.back().xyLimits.minY,
              screens.back().xyLimits.maxY + 1, screens.front());
}

AccessInventory::AccessInventory(std::vector<std::string> &inList, Entity &inEntity, ScreenVals &primaryScreen,
                                 std::string inName, std::vector<int> inOptions, Perimeter inPerim, DrawRange inRange) {
    ...
    drawPrimary(*_primaryScreen);
    drawSmall(_listScreen->xyLimits.minX, _listScreen->xyLimits.maxX, _listScreen->xyLimits.minY,
              _listScreen->xyLimits.maxY + 1, *_listScreen);
    ...
    // drawSmall(_cornerDims.minX, _cornerDims.maxX, _cornerDims.minY,
    // _cornerDims.maxY + 1, *_listScreen);
    drawSmall(_entityListScreen->xyLimits.minX, _entityListScreen->xyLimits.maxX, _entityListScreen->xyLimits.minY,
